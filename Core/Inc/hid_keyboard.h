...
// Modifier keys
#define KEY_CTRL_LEFT      (MODIFIER_KEY_FLAG | 0x01)
#define KEY_SHIFT_LEFT     (MODIFIER_KEY_FLAG | 0x02)
#define KEY_ALT_LEFT       (MODIFIER_KEY_FLAG | 0x04)
#define KEY_META_LEFT      (MODIFIER_KEY_FLAG | 0x08)
#define KEY_CTRL_RIGHT     (MODIFIER_KEY_FLAG | 0x10)
#define KEY_SHIFT_RIGHT    (MODIFIER_KEY_FLAG | 0x20)
#define KEY_ALT_RIGHT      (MODIFIER_KEY_FLAG | 0x40)
#define KEY_META_RIGHT     (MODIFIER_KEY_FLAG | 0x80)
...
#define KEY_BRACE_LEFT          0x2F
#define KEY_BRACE_RIGHT         0x30
#define KEY_BACKSLASH           0x31
#define KEY_NON_US_1            0x32
